...
export function Dashboard({ userName, onOpenGenerate, onOpenChat, onOpenScripts }: DashboardProps) {
  const { kpis, weeklyProduction, durationTrends, topicDistribution } = useDashboardStats()
      ...
      <div className="creator-kpi-row">
        <article className="creator-bento creator-kpi-card">
          ...
          <div>
            ...
            <strong>{kpis.totalScripts}</strong>
        ...
        <article className="creator-bento creator-kpi-card">
          ...
          <div>
            ...
            <strong>{kpis.averageDurationMinutes} min</strong>
        ...
        <article className="creator-bento creator-kpi-card">
          ...
          <div>
            ...
            <strong>{kpis.activeProjects}</strong>
